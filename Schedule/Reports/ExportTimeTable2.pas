...
begin
  ...
  try
    ...
    SourceFrame:=frmDlg.AddPage('Источник',TfrmExportSourcePage) as TfrmExportSourcePage;
    SourceFrame.AssignList(ASchedule);
    ExportFrame:=frmDlg.AddPage('Оформление',TfrmExportTablePage) as TfrmExportTablePage;
