...
//    function ld_Delete(lid: int64): boolean;
    ...
    function sdl_GetLoad_a(aid: int64): _Recordset;
...
// выбор загрузки аудитории в расписании занятий (6/10/06)
function TdmMain.sdl_GetLoad_a(aid: int64): _Recordset;
begin
  Assert(aid>0,
    'EAEAAE33-2A3D-422F-8D8D-C16E51693CB5'#13'sdl_GetLoad_a: invalid aid'#13);

  Result:=_OpenSP(spSchedMgm,['@case','@ynum','@sem','@psem','@aid'],
      [sdlGetLoadAdr,Year,Sem,PSem,aid]);
end;
